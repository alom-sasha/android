...
public class AlertActivity extends AppCompatActivity {
    ...
    private void setupBottomNavigationView(){
        ...
        BottomNavigationViewHelper.enableNavigation(com.example.sasha.AlertActivity.this,bottomNavigationView);
    ...
    private void setupAlertButton(){
        ...
        ImageButton button_report = (ImageButton)findViewById(R.id.button_report);
